...
const ExploreProduct = () => {
  ...
  return (
    <div className="flex flex-col mt-24  h-[165vh]  ">
      <div>
        <HeadTag tagname={"Our Products"} />
      </div>
      ...
      <div className="relative mt-[2em]">
        <div className="absolute w-[70em] h-[120vh]   top-[100%] overflow-hidden   ">
          <div
            className=" w-full h-full absolute top-0 left-0 overflow-x-scroll no-scrollbar   "
            ref={scrollref}
          >
            <div className="absolute  top-0 left-0 h-full w-[150em]   ">
              <div className="flex flex-row justify-around relative h-full   ">
      ...
      <div className="relative top-[50em] flex justify-center ">
